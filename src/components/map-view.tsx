  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-xl border border-border bg-background">
      ...
      <div className="absolute right-3 top-3 z-20 flex flex-col gap-1.5">
        <button className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-card/90 text-foreground shadow-lg backdrop-blur transition-colors hover:bg-secondary" aria-label="Zoom in">
          <span className="text-lg font-bold">+</span>
        </button>
        <button className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-card/90 text-foreground shadow-lg backdrop-blur transition-colors hover:bg-secondary" aria-label="Zoom out">
          <span className="text-lg font-bold">−</span>
        </button>
        <button className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-card/90 text-foreground shadow-lg backdrop-blur transition-colors hover:bg-secondary" aria-label="Recenter">
          <Crosshair className="h-4 w-4 text-info" />
        </button>
      </div>

      {/* Legend */}
      <div className="absolute left-3 top-3 z-20 rounded-lg border border-border bg-card/90 p-3 shadow-lg backdrop-blur">
        <div className="mb-2 flex items-center gap-1.5 text-xs font-semibold text-foreground">
          <Layers className="h-3.5 w-3.5" /> Map Legend
        </div>
      ...
      {/* Offline overlay */}
      {!isOnline && (
        <div className="absolute right-3 bottom-3 z-20 flex items-center gap-2 rounded-lg border border-warning/30 bg-warning/10 px-3 py-2 text-xs font-medium text-warning shadow-lg backdrop-blur">
      ...
      {selected && (
        <div className="absolute inset-x-3 bottom-3 z-30 animate-float-up rounded-xl border border-border bg-card/95 p-4 shadow-2xl backdrop-blur-xl sm:inset-x-4 sm:bottom-4">
          <button
    ...
    return (
      <div>
        ...
        <div className="mt-3 flex gap-2">
          ...
          <button className="flex items-center justify-center gap-1.5 rounded-lg border border-border bg-secondary/50 px-3 py-2 text-xs font-bold transition-colors hover:bg-secondary">
